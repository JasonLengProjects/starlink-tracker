...
import { NEARBY_SATELLITE, STARLINK_CATEGORY, API_KEY, POSITION_URL } from '../constants';
...
class Main extends Component {
    ...
    trackOnClick = (duration) => {
        ...
        const urls = this.state.selected.map(sat => {
            const { satid } = sat;
            const url = `${POSITION_URL}/${satid}/${observerLat}/${observerLong}/${observerAlt}/${endTime}/&apiKey=${API_KEY}`;
